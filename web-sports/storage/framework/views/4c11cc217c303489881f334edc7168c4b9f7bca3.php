...
<html lang="en">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo e(url('/')); ?>">WebSports</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active"><a href="<?php echo e(url('/')); ?>">Início <span class="sr-only">(current)</span></a></li>
            <li><a href="<?php echo e(route('teams.index')); ?>">Times</a></li>
            <li><a href="<?php echo e(route('matches.index')); ?>">Partidas</a></li>
            <li><a href="<?php echo e(route('competitions.index')); ?>">Competições</a></li>
            <li><a href="<?php echo e(route('seasons.index')); ?>">Temporadas</a></li>
            <li><a href="<?php echo e(route('matches.create')); ?>">Criar Partidas</a></li>
          </ul>
        </div>
